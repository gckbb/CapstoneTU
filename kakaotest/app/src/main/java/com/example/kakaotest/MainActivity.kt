...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.emailLoginButton.setOnClickListener {
            ...
            auth!!.createUserWithEmailAndPassword(binding.idEdittext.text.toString(), binding.passwordEdittext.text.toString())
        ...
        binding.idLoginButton.setOnClickListener {
            ...
            auth!!.signInWithEmailAndPassword(binding.idEdittext.toString(), binding.passwordEdittext.text.toString())
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        Toast.makeText(this, "성공", Toast.LENGTH_SHORT).show()
                    } else {
