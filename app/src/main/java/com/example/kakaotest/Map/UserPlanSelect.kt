...
import com.example.kakaotest.databinding.ActivityUserPlanSelectBinding
...
class UserPlanSelect : AppCompatActivity() {
    private var mBinding: ActivityUserPlanSelectBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding = ActivityUserPlanSelectBinding.inflate(layoutInflater)
